...
module "compute" {
    ...
    private_sub_a_id   = module.network.private_sub_a_id
    private_sub_b_id   = module.network.private_sub_b_id
    ...
    jenkins_target_group_arn  = module.network.jenkins_target_group_arn
